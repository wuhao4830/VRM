 ...
 * @author wuhao
 */
public class OldItemWriter implements ItemWriter<OldSkukey> {

	private static final Logger logger = LoggerFactory.getLogger(OldItemWriter.class);
	...
	public void write(List<? extends OldSkukey> oldSkukeys)  {
		for (OldSkukey oldSkukey : oldSkukeys) {
			try {
				genVals.saveOldCommodityVals(oldSkukey.getSkuId()+oldSkukey.getMarketId());
			}catch (Exception e){
