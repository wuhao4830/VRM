 ...
 *
 */
public class HibernateSaleProWriterDao implements
		SaleWriterDao, RepeatListener {
	private List<Throwable> errors = new ArrayList<Throwable>();
	private SessionFactory sessionFactory;
//	private GenVals genVals;
	private JdbcTemplate jdbcTemplate;
	private static final Logger logger = LoggerFactory.getLogger(HibernateSaleProWriterDao.class);
...
//			session.save(sale);
			...
			for(Sale sqlSale:list) {
				String newPro = GenVals.changgeSalePro(sqlSale.getProperties(), sale.getProperties());
				sqlSale.setProperties(newPro);
